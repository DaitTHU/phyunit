...
class Unit:
    ...
    def items(self) -> Iterable[tuple[str, Fraction]]: ...
    def __contains__(self, unit: str | Self) -> bool: ...
    def deprefix(self) -> Self: ...
    def SI_base_form(self) -> Self: ...
...
class Constant(Generic[T]):
    ...
    def deprefix_unit(self) -> Constant[T]: ...
    def to_SI_base_unit(self) -> Constant[T]: ...
    def simplify_unit(self) -> Constant[T]: ...
    def __eq__(self, other: object) -> bool: ...
...
class Quantity(Constant[T]):
    ...
    def to_SI_base_unit(self, *, inplace=False) -> Quantity[T]: ...
